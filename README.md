This repository contains a simple Cordova project which shows how to test using Appium. See the [related blog post](https://medium.com/the-web-tub) for full info.
